...
$('.modalform').on('click', function(){
    $('.modalformw').addClass('active');
    $('.accesoimg a,.menuwbs').addClass('zin');
    $('form').addClass('wt');
  ...
  $('.izform,.sumitb').on('click', function(){
    $('.modalformw').toggleClass('active');
    $('.accesoimg a,.menuwbs').toggleClass('zin');
    $('form').toggleClass('wt');
...
$('.menuwbs').on('click', function(){
    $('#nav').addClass('mostrarmenu2');
  })
  
  $('.cerrarx,.xq,.iconosmenu2,.menumovilchat').on('click', function(){
    $('#nav').removeClass('mostrarmenu2');
  })

  
  $('.aclientes,.achat,.aclientes2,.cardnegocio,.aclientes4,.menumovilchat,.btnnavp,.btnpx').click(function() {
    $('.cardmenu').css('right', '0');
    
    });
    
    
    $('#cerrarchat,.menuwbs').click(function() {
    $('.cardmenu').css('right', '-100%');
    
    });

    $('.xxc,.cerrarx,.xq,.iconosmenu2,.menumovilchat').click(function() {

        
            $('.ulchat').toggleClass('mostrarsubm');
  
        
        
        });

        $('.cerrarx,.xq,.iconosmenu2,.menumovilchat').click(function() {

        
            $('.ulchat').removeClass('mostrarsubm');
...
var whatsapp_number ="&text=Capacitación Vende con Envíos Masivos y prueba gratis de" + "%20" + "*WhatsBulkSender™*" + "%0A"+"✅ _Registro confirmado_" + "%0A"+"_________________________" + "%0A"+"%0A"+ "*😃 Nombre:*" +"%0A" + nombre + "%20" +"%0A"+"%0A" +"*💼 Nombre del Negocio:*" +"%0A" + nombrenegocio +  "%20" + "%0A"+"%0A"+"*🛒 Tipo de Negocio:*"+"%0A" + tipodenegocio + "%20" + "%0A"+"_________________________" + "%0A"+"%0A"+"*🤖 Descarga el software en el siguiente link:*"+"%0A"+"http://bit.ly/WhatsAppMasivoGRATIS"+"%0A"+"%0A"+ "*🚀 Curso paso a paso Vende con WhatsApp Masivo 2021:*"+"%0A"+"https://youtu.be/dV9_eEk65zE"+"%0A"+"%0A"+ "_________________________" + "%0A" + "%0A"+"*P.D.*"+ "%20"+ "Guarda nuestro contacto como *WhatsBulkSender* para activar la herramienta, recibir actualizaciones y soporte 😉👍";
...
var whatsapp_number ="&text=Soporte y Ayuda" + "%20" + "*WhatsBulkSender™*" + "%0A"+"✅ _Registro con éxito_" + "%0A"+"_________________________" + "%0A"+"%0A"+ "*😃 Nombre:*" +"%0A" + nombre + "%20" +"%0A"+"%0A" +"*💼 Nombre del Negocio:*" +"%0A" + nombrenegocio +  "%20" + "%0A"+"%0A"+"*🛒 Tipo de Negocio:*"+"%0A" + tipodenegocio + "%20" + "%0A"+"_________________________" + "%0A"+"%0A"+"*P.D.*"+ "%20"+ "Guarda nuestro contacto como *WhatsBulkSender* para recibir la confirmación del Soporte 😉👍";
